...
COMPRESS : float = 0.0
SEEDING_MASK_FILE_PATH: str = "/Users/mahir/Desktop/MTP/SlicerTracto-extension-with-integrated-modules/DMRI_TRACTOGRAPHY/Input/seeding_mask.nii.gz"
DEFAULT_TRK_FILE_NAME = "result.trk"
DEFAULt_VTK_FILE_NAME = "result.vtk"
DEFAULT_DIR = "/Users/mahir/Desktop/MTP/SlicerTracto-extension-with-integrated-modules/DMRI_TRACTOGRAPHY/Output"
...
class Tractography:
    ...
    def generateTrk(self):
        print("GenerateTrk button clicked. ---- Local computation begins")
